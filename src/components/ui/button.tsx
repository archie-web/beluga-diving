...
const styles = {
  base: [
    // Base
    'relative isolate inline-flex items-center justify-center gap-x-2 border text-base/6 uppercase rounded-xl font-extrabold leading-none',
  ...
  solid: [
    ...
    'before:absolute before:inset-0 before:-z-10 before:rounded-xl before:bg-[--btn-bg]',
    ...
    'after:absolute after:inset-0 after:-z-10 after:rounded-[calc(theme(borderRadius.none)-1px)]',
...
export const Button = React.forwardRef(function Button(
  ...
  return 'href' in props ? (
    ...
    <HeadlessButton {...props} className={clsx(classes, 'cursor-default')} ref={ref} data-testid="button-component">
      <TouchTarget>{children}</TouchTarget>
    </HeadlessButton>
  )
})
